...
import { getDelta } from '../../../scripts/wheel';

import MousePad, { MousePadEvent } from './mousepad';
import { WithRandomIds } from './with-ids';
...
export default class Scroll extends React.Component<IPropScroll, {}> {
  ...
  render() {
    ...
    return (
      <WithRandomIds names={['main']}>
        {({ main }) => {
          const hor = disableX ? null : (
            <div
              role="scrollbar"
              aria-controls={main}
            ...
            >
              <div
                ...
                data-dir="left"
              />
              <div ref={e => (this.horArea = e)} className={styles.hor}>
                <div
                  ref={e => (this.horTip = e)}
          ...
          const ver = disableY ? null : (
            ...
            >
              <div
                ...
                data-dir="up"
              />
              <div ref={e => (this.verArea = e)} className={styles.ver}>
                <div
                  ref={e => (this.verTip = e)}
          ...
          return (
            <div className={styles.outerWrapper} style={wrapperStyle}>
  ...
  setScroll(nx: number | null, ny: number | null) {
    const { x, y, width, height, onScroll } = this.props;
